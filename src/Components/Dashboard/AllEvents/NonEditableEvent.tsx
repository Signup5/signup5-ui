    ...
    <Grid container spacing={3}>
      ...
      <Grid container item xs={12} spacing={3}>
        ...
        <Grid item xs={11}>
          <Typography className={classes.contentText}>
            <StyledBadge
              badgeContent={invitationSummary("ATTENDING")}
              color="primary"
            ...
            <StyledBadge
              badgeContent={invitationSummary("MAYBE")}
              color="primary"
              style={{ marginLeft: "18px" }}
            >
              <Button
            ...
            <StyledBadge
              badgeContent={invitationSummary("NOT_ATTENDING")}
              color="primary"
              style={{ marginLeft: "18px" }}
            >
              <Button
            ...
            <StyledBadge
              badgeContent={invitationSummary("NO_RESPONSE")}
              color="secondary"
              style={{ marginLeft: "18px" }}
            >
              <Button
